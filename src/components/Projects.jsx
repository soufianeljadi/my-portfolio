...
export default function ProjectsSection() {
  ...
  const projects = [
  {
    ...
    img: process.env.PUBLIC_URL + "/assets/INCPTION.png",
    tech: ["Docker"],
  ...
  },
  {
    ...
    img: process.env.PUBLIC_URL + "/assets/Irc.png",
    tech: ["C++"],
  ...
  },
  {
    ...
    img: process.env.PUBLIC_URL + "/assets/minishell.png",
    tech: ["C","Bash"],
  ...
  },
  {
    ...
    img: process.env.PUBLIC_URL + "/assets/URS.png",
    tech: ["PHP", "Laravel"],
  ...
  },    
  {
    ...
    img: process.env.PUBLIC_URL + "/assets/RRS.png",
    tech: ["PHP", "Laravel"],
  ...
  },  
  {
    ...
    img: process.env.PUBLIC_URL + "/assets/Cub3d.png",
    tech: ["C", "Mlx42"],
  ...
  },
  {
    ...
    img: process.env.PUBLIC_URL + "/assets/b2br.png",
    tech: ["Crontab", "Shell"],
  ...
  return (
    <section
      id="projects"
      className="min-h-screen relative py-20 px-8 bg-[#0b0f0d] text-white overflow-hidden"
    >
